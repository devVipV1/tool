...
class zNGL:
    def __init__(self, _username: str = "", _threads: int = 1, _question: str = ""):
        ...
        self._timeout = 15
        self.NAME_TOOL = "Tool NGL"
        self.VERSION_TOOL = "v9"
        if os.name == "nt":os.system(f"title 💰 {self.NAME_TOOL} {self.VERSION_TOOL} MinhDevCrack")
...
Hi I Am Ho Duc Minh, Dev Tool
Fb: https://fb.com/hoducminh.depzai
...
"""
    ...
    def banner(self):
        ...
        text = """
TOOL MAKE BY DUC MINH DEVELOPER
...
\033[0;31m[+] Telegram: @minhiosfefe"""
        )
        print(
            "".join(
                [
